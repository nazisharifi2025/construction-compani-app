...
function Works() {
  return (
    <div className='h-[90vh] w-full flex lg:flex-row flex-col justify-between items-center'>
        <div className='h-full flex flex-col lg:w-1/2 w-full justify-center items-center gap-2'>
            <h1 className='text-5xl font-bold text-center'>Ready to work together?</h1>
