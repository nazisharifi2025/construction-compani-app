  ...
  return (
    <div className='lg:h-[70vh] bg-cover -z-50  bg-no-repeat bg-center bg-[url(/images/bouldeng.avif)]  w-full grid lg:grid-cols-2 grid-cols-1 my-5 overflow-hidden'>
        ...
        className='p-4 flex  clip-path z-10 bg-blue-950/70 justify-start items-center  gap-3'>
          <h2 className='font-bold text-6xl text-amber-600 flex items-center'><ChevronLeft size={67}/> ABOUT US <ChevronRight size={67}/></h2>
        ...
        className='flex justify-end pl-60 items-end clip-path2 h-full bg-blue-950/60 z-10 p-5'>
          <h1 className='text-3xl lg:w-[70%] flex space-x-3 text-white items-center '>Home<ChevronRight size={32} className='text-amber-600'/>About us</h1>
